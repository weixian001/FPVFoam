...
Foam::canteraReader::canteraReader(const IOdictionary& canteraDict, const IOdictionary& sPortionDict, rhoReactionThermo& thermo, basicMultiComponentMixture& composition) //amended
